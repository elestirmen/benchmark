...
if __name__ == '__main__':
    ...
    for i in range(len(haritalar_klasoru)):
        ...
        while(True):
            ...
            inputs=[(ana_harita,template1,cv2.TM_CCOEFF,None),(ana_harita,template2,cv2.TM_CCOEFF,None)]
            outputs1 = [pool.apply_async(cv2.matchTemplate, args=inpt) for inpt in inputs]
        ...
        anlik_name="_"+haritalar_klasoru[i][27:70]
